      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2.5rem' }}>
        <div className="cp-layout" style={{ display: 'flex', gap: '3rem', alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: '0 0 40%', maxWidth: '40%' }}>
            ...
            {/* Large preview */}
            <div style={{
              width: '100%', aspectRatio: '1/1', borderRadius: '4px', overflow: 'hidden',
            ...
            {current.name && (
              <p className="font-display" style={{
                ...
                fontSize: '1.125rem', fontStyle: 'italic', color: '#6B5D4E',
              }}>
                {current.name}
              </p>
            )}
                ...
                return (
                  ...
                  >
                    <div style={{
                      ...
                      border: isActive ? '3px solid #C4A882' : '3px solid transparent',
                      boxShadow: isActive ? '0 4px 12px rgba(196,168,130,0.3)' : '0 2px 8px rgba(0,0,0,0.06)',
                    ...
                    <span className="font-body" style={{
                      ...
                      fontSize: '0.75rem', color: isActive ? '#1A1714' : '#8B7D6B',
